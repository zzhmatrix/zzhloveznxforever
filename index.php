...
<head>
	...
	<meta name="author" content="情人节,表白程序,情人节表白程序,自动生成表白程序">
	<meta name="description" content="宝贝蛋和宝贝老婆的爱情故事!">
	<title>宝贝蛋和宝贝老婆的爱情故事</title>
...
<body>
	...
	<div class="write-ok">
		<div class="write-box">
			<h2>还差一步即可生成表白页面</h2>
			<p id="write-mp3">自定义背景音乐：<span id="text-music" contenteditable="true">http://<?php echo $_SERVER['HTTP_HOST']; ?>/music/lovebgm</span><i></i>.mp3</p>
			<p id="write-url">自定义表白链接：<u>http://<?php echo $_SERVER['HTTP_HOST']; ?>/jae/2014/</u><span id="text-href" contenteditable="true"><?php echo time(); ?></span><i></i><u>.html</u></p>
